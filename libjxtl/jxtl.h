...
typedef struct jxtl_callback_t {
  ...
  int ( *param_decl_handler )( void *user_data, char *name, char *expr );
  int ( *param_usage_handler )( void *user_data, char *name );
  ...
  void ( *separator_handler )( void *user_data, char *expr );
